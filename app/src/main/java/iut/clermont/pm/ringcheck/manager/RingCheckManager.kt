...
import iut.clermont.pm.ringcheck.MainActivity
...
class RingCheckManager {
    ...
    fun setAlarm(activity : Activity){
        ...
        alarmManager.setRepeating(
            alarmType, SystemClock.elapsedRealtime() + TWO_SEC_MILLIS,
            TWO_SEC_MILLIS.toLong(), pendingIntent
        )
